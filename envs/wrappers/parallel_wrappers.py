...
class ParallelAdversarialVecEnv(SubprocVecEnv):
   ...
   # reset_to_level
    ...
    def get_num_lava(self):
        return self.remote_attr('n_lava_placed', flatten=True)

    def get_num_doors(self):
        return self.remote_attr('n_doors_placed', flatten=True)

    def get_num_walls(self):
        return self.remote_attr('n_walls_placed', flatten=True)

    def get_max_dim(self):
        return self.remote_attr('max_dim', flatten=True)
